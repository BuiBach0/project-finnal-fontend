...
export default function EditTaskForm(props: {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    mutate(payload, {
      onSuccess: (data) => {
        console.log(task?.project?._id, "vantu111");
        queryClient.invalidateQueries({
          queryKey: ["singleProject", task?.project?._id],
        });
                      ...
                      <Input
                        ...
                        onKeyDown={(e) => {
                          if (e.code === "Space" || e.key === " ") {
                            e.stopPropagation(); // ✅ ngăn chặn chặn phím space từ bên ngoài
                          }
                        }}
                      />
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        onKeyDown={(e) => {
                          if (e.code === "Space" || e.key === " ") {
                            e.stopPropagation(); // ✅ xử lý tương tự input
                          }
                        }}
                      />
                    </FormControl>
